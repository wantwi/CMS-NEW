...
import { fetchList, removeItem, selectAllItems } from '../../../features/setups/committeeSetupSlice'
    ...
    <Fragment>
      <Card style={{ padding: 20 }}>
        <CardHeader className='flex-md-row flex-column align-md-items-center align-items-start border-bottom'>
          <CardTitle tag='h4'>Committee Setup</CardTitle>
      ...
      <AddNewModal title="New committee" open={modal} handleModal={handleModal} />
    </Fragment>
  )
}
