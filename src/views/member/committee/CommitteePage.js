  ...
  return (
    <Fragment>
      <Card>
        ...
        <Row className='mx-0' style={{ justifyContent: 'space-between' }}>
          <Col className='d-flex align-items-center justify-content-start mt-1' md='4' sm='12'>
            <Input size='sm' type='select' id='select-plan' name='select-plan' style={{ height: 30 }}>
              <option value=''>Select committee</option>
              <option value='Leader'>Welfare</option>
              <option value='Class Leader'>Youth & Education</option>
              <option value='Organization Head'>Evangelism</option>
      ...
      <SectionModal modal={modal} setModal={setModal}>
        <Row className='mx-0' style={{ justifyContent: 'space-between' }}>
