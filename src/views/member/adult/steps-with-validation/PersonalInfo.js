...
const PersonalInfo = ({formData, setformData, stepper }) => {
  // ** Hooks
  const {
    control,
    setError,
      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
        <Row>
          ...
          <Col md='4' className='mb-1'>
            ...
            <Input placeholder='Other' name='other' value={formData.other} onChange={(e) => setformData((pre) => ({...pre, [e.target.name]: e.target.value}))}  />
            {/* <Controller
              id='other'
              name='other'
              control={control}
              render={({ field }) => <Input placeholder='Other'  {...field} />}
            /> */}
